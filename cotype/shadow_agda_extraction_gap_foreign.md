...
**Tracking**: [v4cat-oss/agda2v4cat#6](https://github.com/v4cat-oss/agda2v4cat/issues/6) (status canonical there per [shadow_workspace_project_tracking.md](shadow_workspace_project_tracking.md)).
